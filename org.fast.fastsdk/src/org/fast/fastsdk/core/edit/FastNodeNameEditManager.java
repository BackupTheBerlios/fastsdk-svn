 ...
 * @author …Ú»›÷€
 */
public class FastNodeNameEditManager extends DirectEditManager {

    private IActionBars             actionBars;

    private CellEditorActionHandler actionHandler;

    private IAction                 copy, cut, paste, undo, redo, find,
            selectAll, delete;
    ...
    public FastNodeNameEditManager(GraphicalEditPart source,
    ...
    protected void initCellEditor() {
        // update text
        FastNodeFigure fastNode = (FastNodeFigure) getEditPart().getFigure();
        getCellEditor().setValue(fastNode.getName());
        // update font
        ZoomManager zoomMgr = (ZoomManager) getEditPart().getViewer()
                .getProperty(ZoomManager.class.toString());
        if (zoomMgr != null) {
            ...
            getCellEditor().getControl().setFont(fastNode.getFont());
